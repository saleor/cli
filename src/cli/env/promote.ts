...
import { promptVersionToPromote } from "../../lib/util.js";
...
export const handler = async (argv: Arguments<Options>) => {
  ...
  const service = await promptVersionToPromote({...argv, region: env.service.region, serviceName: `?compatible_with=${env.service.version}` });
